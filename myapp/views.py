...
def new_search(request):
    ...
    data = response.text
    soup = BeautifulSoup(data, features='html.parser')  #parses data into more managable way and not just raw html
    ...
    return render(request, 'myapp/searchitem.html', stuff_for_frontend)